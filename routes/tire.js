...
router.post('/tire/:id',auth,async(req,res)=>{
...
router.patch('/tire/:vechileid/:tireid',auth,async(req,res)=>{
    ...
    req.body.parts.forEach(element => {
        ...
        const partsAllowedUpdates = ['partname','cost','quantity','hsn','partnumber','gst']
